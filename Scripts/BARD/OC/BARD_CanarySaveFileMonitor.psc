Scriptname BARD:OC:Bard_CanarySaveFileMonitor extends Quest

String sThisFullScriptName = "BARD:OC:Bard_CanarySaveFileMonitor" Const
...
Event OnQuestInit()
    ...
    Debug.TraceUser("BARD_ObjectsLocator", "Canary Support Installed")
EndEvent
